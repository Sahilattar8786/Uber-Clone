  ...
  return (
    <SafeAreaView className="bg-general-500">
      <FlatList 
       ...
       ListHeaderComponent={()=>(
        <>
          <View className='flex flex-row items-center justify-between my-5 m-3'>
            ...
            <GoogleTextInput 
             ...
             />
             <>
               <Text className='text-xl font-JakartaBold mt-5 mb-3 ml-4'>Your Current location </Text>
             ...
             <Text className='text-xl font-JakartaBold mt-5 mb-3 ml-4'>Recent Ride</Text>
        </>
       )}
